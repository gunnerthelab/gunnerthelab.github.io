# gunnerthelab.github.io — Claude Code Context
...
├── resources/
    ├── about_the_series.md
    ├── Branding_Illustration_Prompts.md
    ├── copyright.md
    ├── Gunner_and_Tiger_Story_List.md
    └── Illustration_Prompts_All_Stories.md
├── src/
    ├── assets/
    ├── components/
    ├── content/
